<?php
// session_start();
// $adminprofile = $_SESSION["adminname"];
...
<body>
  ...
  <header class="page-header">
    <nav>
      <a href="#0" aria-label="forecastr logo" class="logo" style="display:flex; align-items: center; gap:10px; ">
        <!-- <svg width="140" height="49">
              <use xlink:href="#logo"></use>
            </svg> -->
        <img src="images\logo1.jpg" alt="" width="50px" height="49px" style="background-color: #1d2636;  border-radius: 10px;"> <span style="font-weight: 600; font-size: 25px;">DB Store</span>
